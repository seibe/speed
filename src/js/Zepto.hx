...
typedef ZeptoEvent = {>Event,
	function isDefaultPrevented():Bool;
	function isImmediatePropagationStopped():Bool;
	function isPropagationStopped():Bool;
};
typedef ZeptoMouseEvent = {>MouseEvent,
	function isDefaultPrevented():Bool;
	function isImmediatePropagationStopped():Bool;
	function isPropagationStopped():Bool;
};
typedef ZeptoTouchEvent = {>TouchEvent,
	function isDefaultPrevented():Bool;
	function isImmediatePropagationStopped():Bool;
	function isPropagationStopped():Bool;
};
...
extern class Zepto implements ArrayAccess<Element>
{
	...
	function before(content:String):ZeptoSelf;
	...
	@:overload(function(it:Int->String->String):ZeptoSelf{})
	@:overload(function(content:String):ZeptoSelf{})
	...
	function prepend(content:String):ZeptoSelf;
	...
	function ready(callback:Zepto->Void):ZeptoSelf;
	...
	function replaceWidth(content:String):ZeptoSelf;
